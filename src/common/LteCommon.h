...
#define MAX_CODEWORDS 4 //VH _max_codewords
...
const unsigned char MAXCW = 4; //VH _maxcw
const Cqi MAXCQI = 15;
...
struct UeInfo
{
    ...
    omnetpp::cModule * ue;
    LtePhyBase* phy;
    double lastProcDemand; // last calculated UE's processing demand (Eq.)
    double fullLastProcDemand;
};
