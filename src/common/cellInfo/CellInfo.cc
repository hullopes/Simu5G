...
// The above files and the current reference are part of the software itself,
...
void CellInfo::initialize(int stage)
{
    if (stage == inet::INITSTAGE_LOCAL)
    {
        ...
        currentTxModeId_ = par("currentTxModeId");
        currentLayers_   = par("currentLayers");
        currentMaxRI_    = par("currentMaxRI");
        currentMaxModOrder_ = par("currentMaxModOrder");
        ...
        binder_->setCurrentTxModeId(currentTxModeId_);
        binder_->setCurrentLayers(currentLayers_);
        binder_->setCurrentMaxRI(currentMaxRI_);
        binder_->setCurrentMaxModOrder(currentMaxModOrder_);
        binder_->setCurrentMaxRBs(currentMaxRBs_);
