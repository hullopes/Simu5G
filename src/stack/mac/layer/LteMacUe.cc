...
//    }
    ...
    else if (stage == INITSTAGE_NETWORK_LAYER)
    {
        ...
        //!VH add processing capacity
        info->lastProcDemand = 0.0;


        binder_->addUeInfo(info);
        //binder_->setUECurrentProcessingDenand(nodeId_, 10.0); //!VH exemplo de como alterar a demanda de processamento
